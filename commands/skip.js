...
module.exports.run = async (client, message, args, options) => {
    ...
    if (guildIDData.queue[0].voteSkips.includes(message.member.id)) return message.channel.send("Sorry you skipped like one ");
    ...
    message.channel.send(`Added from skip request. ${guildIDData.queue[0].voteSkips.length}/${amountSkip}`);
